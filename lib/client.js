 ...
 * web module system). Renders the header utilities bar: balance capsule
 * (with inline refresh) and session stats badges. Session-log download is
 * provided by the built-in @deepseek-ai/dsh-session-log-export package.
