...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function apply(ctx) {
      ...
      // Immutable updates: every patch REPLACES the store object. Mutating in
      // place and passing the same reference to React setState would make
      // useState bail out (Object.is equality) and skip the re-render, so the
      // panel would never open and refreshes would never show.
